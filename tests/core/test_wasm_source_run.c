 ...
 * @brief Tests for the Wasm-facing source execution API through Phase 89 Irvine32 WriteString.
 *
...
#define TEST_SOURCE_RUN_OUTPUT_CONTRACT_FRAGMENT "\"sourceRunOutputContract\":\"phase-89-irvine32-writestring-contract-v1\""

/// Exact empty Program Console object expected before Irvine32 output routines exist.
...
static int test_minimal_source_runs_to_eax_42(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "response should identify current runtime phase");
...
static int test_phase24_eax_base_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 26 EAX-base response should identify current runtime phase");
...
static int test_all_gpr_register_indirect_source_run_succeeds(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "all-GPR response should identify current runtime phase");
...
static int test_phase22_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 22 response should identify current runtime phase");
...
static int test_signed_ptr_alias_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "signed PTR alias response should identify current runtime phase");
...
static int test_phase20_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "source-run response should identify current runtime phase");
...
static int test_phase25_register_supplied_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 26 source-run response should identify current runtime phase");
...
static int test_phase25_register_supplied_source_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 26 source-memory response should identify current runtime phase");
...
static int test_phase25_explicit_ptr_symbol_register_override_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Explicit PTR override source-run response should identify current runtime phase");
...
static int test_phase26_header_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 26 header response should identify current runtime phase");
...
static int test_phase28_additional_data_sections_source_run_programs(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":89", "Phase 30 response should identify current runtime phase");
...
static int test_phase30_dup_initializer_list_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "DUP initializer list source should report current runtime/source-run MASM behavior phase metadata");
...
static int test_phase41_irvine32_virtual_include_metadata_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Irvine32 virtual include response should report current runtime/source-run MASM behavior phase metadata");
...
static int test_phase42_irvine32_exit_terminator_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Irvine32 exit response should report current runtime/source-run MASM behavior phase metadata");
...
static int test_phase43_inc_dec_register_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 43 INC/DEC response should report current runtime metadata");
...
static int test_phase44_logical_binary_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 44 logical response should report current runtime metadata");
...
static int test_phase45_not_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Milestone 45 NOT regression response should report current runtime/source-run MASM behavior phase metadata");
...
static int test_phase46_shift_left_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 46 SHL/SAL response should report current runtime metadata");
...
static int test_phase47_shr_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 47 SHR regression should report current runtime/source-run MASM behavior phase metadata");
...
static int test_phase48_sar_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 48 SAR response should report current runtime metadata");
...
static int test_phase49_rol_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 49 ROL response should report current runtime metadata");
...
static int test_phase50_ror_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 50 ROR response should report current runtime metadata");
...
static int test_phase52_lea_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 52 LEA response should report current runtime metadata");
...
static int test_phase57corr2_compact_negative_displacement_write_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 57-CORR2 write response should report current numeric runtime metadata");
...
static int test_phase57corr2_compact_negative_displacement_read_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 57-CORR2 read response should report current numeric runtime metadata");
...
static int test_phase57corr2_compact_negative_displacement_lea_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 57-CORR2 LEA response should report current numeric runtime metadata");
...
static int test_phase53_mul_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 53 MUL response should report current runtime metadata");
...
static int test_phase56_div_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 56 DIV response should report current runtime metadata");
...
static int test_phase57_idiv_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 57 IDIV response should report runtime metadata");
...
static int test_phase54_imul_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 54 IMUL response should report current runtime metadata");
...
static int test_phase55_imul_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 55 IMUL response should report current runtime metadata");
...
static int test_phase57e_default_startup_state_notice_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Startup-state notice regression should report current numeric phase metadata");
...
static int test_phase58_label_source_run_behavior(void) {
    ...
    failures += expect_json_contains(labeled_copy, "\"phase\":89", "Labeled source should report numeric current runtime phase metadata");
    failures += expect_json_contains(labeled_copy, "\"phaseName\":\"Phase 89 - Irvine32 WriteString\"", "Labeled source should report current runtime phase name");
...
static int test_phase64_equality_jumps_source_run_programs(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":89", "Equality-jump regression should report current numeric phase metadata");
    failures += expect_json_contains(acceptance_json, "\"phaseName\":\"Phase 89 - Irvine32 WriteString\"", "Equality-jump regression should report current runtime phase name");
...
static int test_phase65_signed_relational_jumps_source_run_programs(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":89", "current runtime acceptance program should report numeric metadata");
    failures += expect_json_contains(acceptance_json, "\"phaseName\":\"Phase 89 - Irvine32 WriteString\"", "current runtime acceptance program should report runtime phase name");
...
static int test_phase69_direct_call_source_run_behavior(void) {
    ...
    failures += expect_json_contains(valid_copy, "\"phase\":89", "Phase 69 CALL regression fixture should report current runtime metadata");
...
static int test_phase71_call_ret_source_run_behavior(void) {
    ...
    failures += expect_json_contains(success_copy, "\"phase\":89", "Phase 71 CALL/RET acceptance program should report numeric phase metadata");
    failures += expect_json_contains(success_copy, "\"phaseName\":\"Phase 89 - Irvine32 WriteString\"", "Phase 71 CALL/RET acceptance program should report runtime phase name");
...
static int test_phase82_zero_argument_invoke_source_run_semantics(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":89", "Current metadata should accompany accepted zero-argument INVOKE source");
...
static int test_current_source_run_phase_metadata(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Current runtime metadata should report numeric Phase 89 metadata");
    failures += expect_json_contains(json, "\"phaseSuffix\":\"\"", "Current runtime metadata should report empty suffix metadata");
    failures += expect_json_contains(json, "\"phaseName\":\"Phase 89 - Irvine32 WriteString\"", "Current runtime metadata should report the Phase 89 runtime phase name");
...
static int test_phase81_proto_source_run_non_effect(void) {
    ...
    failures += expect_json_contains(accepted_json, "\"phase\":89", "accepted PROTO source-run should report current numeric phase");
...
static int test_phase67a_entry_procedure_runtime_boundary_source_run(void) {
    ...
    failures += expect_json_contains(before_copy, "\"phase\":89", "Phase 67A helper-before-entry source should report numeric phase metadata");
...
static int test_phase59_instruction_limit_source_run(void) {
    ...
    failures += expect_json_contains(invalid_json, TEST_EMPTY_PROGRAM_CONSOLE_FRAGMENT, "Invalid instructionLimit response should include Phase 89 empty Program Console limit fields");
...
static int test_phase50b_undefined_flag_use_warn_policy_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 50B source-run response should report current numeric runtime metadata");
...
static int test_phase57corr1_const_cross_region_write_diagnostic_context(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Phase 57-CORR1 regression should report current runtime/source-run phase metadata");
...
static int test_phase61_jmp_executes_after_prior_instruction(void) {
    ...
    failures += expect_json_contains(json_copy, "\"phase\":89", "JMP regression response should report current Phase 78 numeric phase metadata");
...
static int test_phase61a_jmp_skips_memory_write_and_keeps_console_empty(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "current runtime should report numeric phase metadata");
    failures += expect_json_contains(json, "\"phaseName\":\"Phase 89 - Irvine32 WriteString\"", "Current runtime metadata should report the Phase 89 runtime phase name");
...
static int test_phase73_leave_source_run_semantics_and_diagnostics(void) {
    ...
    failures += expect_json_contains(direct_json, "\"phase\":89", "Current metadata should report numeric Phase 89");
    failures += expect_json_contains(direct_json, "\"phaseSuffix\":\"\"", "Current metadata should report empty suffix metadata");
    failures += expect_json_contains(direct_json, TEST_SOURCE_RUN_OUTPUT_CONTRACT_FRAGMENT, "Current metadata should report the Phase 89 output contract");
...
static int test_phase73_source_run_default_metadata_and_call_depth(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":89", "Current default source-run metadata should report numeric phase");
    failures += expect_json_contains(json, "\"phaseSuffix\":\"\"", "Current default source-run metadata should report suffix metadata");
    failures += expect_json_contains(json, "\"phaseName\":\"Phase 89 - Irvine32 WriteString\"", "Current default source-run metadata should report full Phase 89 name");
...
static int test_phase74_ret_imm16_source_run_semantics_and_diagnostics(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":89", "Phase 74 RET imm16 regression should report current numeric phase");
...
static int test_phase72_invalid_call_depth_limit_source_run(void) {
    ...
    failures += expect_json_contains(low_copy, TEST_EMPTY_PROGRAM_CONSOLE_FRAGMENT, "Invalid callDepthLimit response should include Phase 89 empty Program Console limit fields");
    failures += expect_json_contains(high_json, TEST_EMPTY_PROGRAM_CONSOLE_FRAGMENT, "Oversized callDepthLimit response should include Phase 89 empty Program Console limit fields");
...
static int test_phase78a_nokeyword_source_run(void) {
    ...
    failures += expect_json_contains(success_json, "\"phase\":89", "Current metadata should report numeric Phase 89");
    failures += expect_json_contains(success_json, "\"phaseSuffix\":\"\"", "Current metadata should report an empty suffix");
    failures += expect_json_contains(success_json, TEST_SOURCE_RUN_OUTPUT_CONTRACT_FRAGMENT, "Current metadata should report the Phase 89 output contract");
...
static int test_phase79_local_frame_source_run(void) {
    ...
    failures += expect_json_contains(success_json, "\"phase\":89", "Phase 79 LOCAL frame source should report current numeric phase");
...
int main(int argc, char **argv) {
    ...
    if (has_filter) {
        ...
        puts("Source execution tests through Phase 89 Irvine32 WriteString passed.");
    }
    return 0;
}
