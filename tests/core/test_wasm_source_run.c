 ...
 * @brief Tests for the Milestone 28 Wasm-facing source execution API.
 *
...
/// Verifies the Milestone 28 register-indirect source-run acceptance program.
///
/// @return Number of failures.
...
static int test_phase24_eax_base_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":28", "Phase 26 EAX-base response should identify Milestone 28");
...
/// Verifies the Milestone 28 TYPE acceptance program through the source-run API.
///
/// @return Number of failures.
...
/// Verifies the Milestone 28 LENGTHOF acceptance program through the source-run API.
///
/// @return Number of failures.
...
/// Verifies the Milestone 28 SIZEOF and character-literal acceptance program through the source-run API.
///
/// @return Number of failures.
...
/// Verifies the Milestone 28 constant symbol-offset acceptance program.
///
/// @return Number of failures.
...
static int test_phase22_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":28", "Phase 22 response should identify Milestone 28");
...
/// Verifies Milestone 28 source-run JSON reports multiple recovered unsupported features.
///
/// @return Number of failures.
...
/// Verifies the Milestone 28 signed declaration acceptance program.
///
/// @return Number of failures.
...
/// Verifies Milestone 28 signed PTR alias reads through the source-run API.
///
/// @return Number of failures.
static int test_signed_ptr_alias_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":28", "signed PTR alias response should identify Milestone 28");
...
/// Verifies Milestone 28 signed PTR alias writes through register-indirect memory.
///
/// @return Number of failures.
...
/// Verifies Milestone 28 signed PTR alias error diagnostics through source-run.
///
/// @return Number of failures.
...
/// Verifies the Milestone 28 sign/zero-extension acceptance program.
///
/// @return Number of failures.
...
static int test_phase20_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":28", "source-run response should identify Milestone 28");
...
static int test_phase25_register_supplied_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":28", "Phase 26 source-run response should identify Milestone 28");
...
static int test_phase25_register_supplied_source_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":28", "Phase 26 source-memory response should identify Milestone 28");
...
static int test_phase25_explicit_ptr_symbol_register_override_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":28", "Explicit PTR override source-run response should identify Milestone 28");
...
static int test_phase26_header_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":28", "Phase 26 header response should identify Milestone 28");
...
/// Verifies Phase 28 .DATA? and .CONST source-run behavior.
///
/// @return Number of failures.
static int test_phase28_additional_data_sections_source_run_programs(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":28", "Phase 28 response should identify Milestone 28");
    failures += expect_json_contains(acceptance_json, "\"ok\":true", "Phase 28 acceptance source should execute");
    failures += expect_json_contains(acceptance_json, "\"EAX\":{\"hex\":\"00000010h\",\"unsigned\":16}", "Phase 28 acceptance source should set EAX to SIZEOF buf");
    failures += expect_json_contains(acceptance_json, "\"EBX\":{\"hex\":\"0000000Ah\",\"unsigned\":10}", "Phase 28 acceptance source should read .CONST limit");
    failures += expect_json_contains(acceptance_json, "\"code\":\"execution-complete\"", "Phase 28 acceptance source should complete execution");
...
int main(void) {
    ...
    puts("Milestone 28 source execution tests passed.");
    return 0;
}
