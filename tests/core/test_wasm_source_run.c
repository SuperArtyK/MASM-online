 ...
 * @brief Tests for the Wasm-facing source execution API through Phase 48 regression coverage.
 *
...
static int test_minimal_source_runs_to_eax_42(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "response should identify Milestone 48");
...
static int test_phase24_eax_base_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Phase 26 EAX-base response should identify Milestone 48");
...
static int test_all_gpr_register_indirect_source_run_succeeds(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "all-GPR response should identify Milestone 48");
...
static int test_phase22_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Phase 22 response should identify Milestone 48");
...
static int test_signed_ptr_alias_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "signed PTR alias response should identify Milestone 48");
...
static int test_phase20_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "source-run response should identify Milestone 48");
...
static int test_phase25_register_supplied_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Phase 26 source-run response should identify Milestone 48");
...
static int test_phase25_register_supplied_source_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Phase 26 source-memory response should identify Milestone 48");
...
static int test_phase25_explicit_ptr_symbol_register_override_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Explicit PTR override source-run response should identify Milestone 48");
...
static int test_phase26_header_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Phase 26 header response should identify Milestone 48");
...
static int test_phase28_additional_data_sections_source_run_programs(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":48", "Phase 30 response should identify Milestone 48");
...
static int test_phase30_dup_initializer_list_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "DUP initializer list source should report Milestone 48");
...
static int test_phase41_irvine32_virtual_include_metadata_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Irvine32 virtual include response should report current milestone metadata");
...
static int test_phase42_irvine32_exit_terminator_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Irvine32 exit response should report current milestone metadata");
...
static int test_phase43_inc_dec_register_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Phase 43 INC/DEC response should report milestone metadata");
...
static int test_phase44_logical_binary_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Phase 44 logical response should report milestone metadata");
...
/// Verifies Milestone 45 NOT acceptance behavior through Phase 48 source-run JSON.
///
/// @return Number of failures.
static int test_phase45_not_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Milestone 45 NOT regression response should report current Phase 48 metadata");
...
/// Verifies Milestone 45 NOT memory behavior through Phase 48 source-run JSON.
///
/// @return Number of failures.
...
/// Verifies Milestone 45 NOT source-run diagnostic paths as Phase 48 regressions.
///
/// @return Number of failures.
...
static int test_phase46_shift_left_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Phase 46 SHL/SAL response should report milestone metadata");
...
/// Verifies Phase 47 SHR acceptance behavior as a Phase 48 regression.
///
/// @return Number of failures.
static int test_phase47_shr_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Phase 47 SHR regression should report Phase 48 metadata");
...
/// Verifies Phase 47 SHR memory and count-zero behavior as a Phase 48 regression.
///
/// @return Number of failures.
...
/// Verifies Phase 47 SHR diagnostic and strict-mode paths as a Phase 48 regression.
///
/// @return Number of failures.
...
static int test_phase48_sar_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":48", "Phase 48 SAR response should report milestone metadata");
...
int main(void) {
    ...
    puts("Source execution tests through Phase 48 regression coverage passed.");
    return 0;
}
