 ...
 * @brief Tests for the Wasm-facing source execution API through Phase 63 CMP memory operand execution.
 *
...
static int test_minimal_source_runs_to_eax_42(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "response should identify Phase 63");
...
static int test_phase24_eax_base_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 26 EAX-base response should identify Phase 63");
...
static int test_all_gpr_register_indirect_source_run_succeeds(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "all-GPR response should identify Phase 63");
...
static int test_phase22_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 22 response should identify Phase 63");
...
static int test_signed_ptr_alias_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "signed PTR alias response should identify Phase 63");
...
static int test_phase20_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "source-run response should identify Phase 63");
...
static int test_phase25_register_supplied_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 26 source-run response should identify Phase 63");
...
static int test_phase25_register_supplied_source_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 26 source-memory response should identify Phase 63");
...
static int test_phase25_explicit_ptr_symbol_register_override_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Explicit PTR override source-run response should identify Phase 63");
...
static int test_phase26_header_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 26 header response should identify Phase 63");
...
static int test_phase28_additional_data_sections_source_run_programs(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":63", "Phase 30 response should identify Phase 63");
...
static int test_phase30_dup_initializer_list_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "DUP initializer list source should report runtime/source-run MASM behavior phase metadata");
...
static int test_phase41_irvine32_virtual_include_metadata_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Irvine32 virtual include response should report runtime/source-run MASM behavior phase metadata");
...
static int test_phase42_irvine32_exit_terminator_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Irvine32 exit response should report runtime/source-run MASM behavior phase metadata");
...
static int test_phase43_inc_dec_register_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 43 INC/DEC response should report milestone metadata");
...
static int test_phase44_logical_binary_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 44 logical response should report milestone metadata");
...
static int test_phase45_not_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Milestone 45 NOT regression response should report runtime/source-run MASM behavior phase metadata");
...
static int test_phase46_shift_left_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 46 SHL/SAL response should report milestone metadata");
...
static int test_phase47_shr_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 47 SHR regression should report runtime/source-run MASM behavior phase metadata");
...
static int test_phase48_sar_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 48 SAR response should report milestone metadata");
...
static int test_phase49_rol_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 49 ROL response should report milestone metadata");
...
static int test_phase50_ror_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 50 ROR response should report milestone metadata");
...
static int test_phase52_lea_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 52 LEA response should report milestone metadata");
...
static int test_phase57corr2_compact_negative_displacement_write_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 57-CORR2 write response should report numeric runtime Phase 63 metadata");
...
static int test_phase57corr2_compact_negative_displacement_read_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 57-CORR2 read response should report numeric runtime Phase 63 metadata");
...
static int test_phase57corr2_compact_negative_displacement_lea_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 57-CORR2 LEA response should report numeric runtime Phase 63 metadata");
...
static int test_phase53_mul_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 53 MUL response should report milestone metadata");
...
static int test_phase56_div_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 56 DIV response should report milestone metadata");
...
static int test_phase57_idiv_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 57 IDIV response should report runtime metadata");
...
static int test_phase54_imul_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 54 IMUL response should report milestone metadata");
...
static int test_phase55_imul_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 55 IMUL response should report milestone metadata");
...
static int test_phase57e_default_startup_state_notice_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Startup-state notice regression should report current numeric phase metadata");
...
static int test_phase58_label_source_run_behavior(void) {
    ...
    failures += expect_json_contains(labeled_copy, "\"phase\":63", "Labeled source should report numeric Phase 63 metadata");
    failures += expect_json_contains(labeled_copy, "\"phaseName\":\"Phase 63 - CMP Memory Operand Forms\"", "Labeled source should report Phase 63 runtime phase name");
...
/// Verifies Phase 63 runtime/source-run status metadata is emitted by source-run JSON.
///
/// @return Number of failures.
static int test_phase63_source_run_phase_metadata(void) {
    const char *json = masm32_sim_wasm_run_source_json(
        ".code\n"
        "main PROC\n"
        "END main\n"
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Runtime metadata should report numeric Phase 63 metadata");
    failures += expect_json_contains(json, "\"phaseSuffix\":\"\"", "Phase 63 should report the suffix field");
    failures += expect_json_contains(json, "\"phaseName\":\"Phase 63 - CMP Memory Operand Forms\"", "Phase 63 should report the runtime phase name");
...
static int test_phase57i_const_uninitialized_storage_acceptance_source_run(void) {
    ...
    failures += expect_json_contains(zero_copy, "\"phaseSuffix\":\"\"", ".CONST ? fixture should report the current Phase 63 runtime phase suffix");
...
static int test_phase50b_undefined_flag_use_warn_policy_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 50B source-run response should report current numeric milestone metadata");
...
static int test_phase57l_code_memory_access_diagnostics_source_run(void) {
    ...
    failures += expect_json_contains(byte_read_json, "\"phaseSuffix\":\"\"", ".code read should report the current Phase 63 runtime phase suffix");
...
static int test_phase57m_segment_symbol_source_run(void) {
    ...
    failures += expect_json_contains(offset_text_json, "\"phaseSuffix\":\"\"", "segment diagnostics should report the current Phase 63 runtime phase suffix");
...
static int test_phase57corr1_const_cross_region_write_diagnostic_context(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 57-CORR1 must not advance runtime/source-run phase metadata");
...
static int test_phase61_jmp_executes_after_prior_instruction(void) {
    ...
    failures += expect_json_contains(json_copy, "\"phase\":63", "JMP regression response should report Phase 63 numeric phase metadata");
...
static int test_phase61a_jmp_skips_memory_write_and_keeps_console_empty(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":63", "Phase 63 should report numeric phase metadata");
    failures += expect_json_contains(json, "\"phaseName\":\"Phase 63 - CMP Memory Operand Forms\"", "Phase 63 should report the runtime phase name");
...
int main(void) {
    ...
    failures += test_phase63_source_run_phase_metadata();
    ...
    puts("Source execution tests through Phase 63 CMP memory operands passed.");
    return 0;
}
