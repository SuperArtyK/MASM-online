 ...
 * @brief Tests for the Wasm-facing source execution API through Phase 75 PROC diagnostics coverage.
 *
...
#define TEST_SOURCE_RUN_OUTPUT_CONTRACT_FRAGMENT "\"sourceRunOutputContract\":\"phase-75-proc-metadata-output-contract-v1\""
...
static int test_phase24_eax_base_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 26 EAX-base response should identify current runtime phase");
...
static int test_phase22_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 22 response should identify current runtime phase");
...
static int test_signed_ptr_alias_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "signed PTR alias response should identify current runtime phase");
...
static int test_phase20_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "source-run response should identify current runtime phase");
...
static int test_phase25_register_supplied_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 26 source-run response should identify current runtime phase");
...
static int test_phase25_register_supplied_source_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 26 source-memory response should identify current runtime phase");
...
static int test_phase25_explicit_ptr_symbol_register_override_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Explicit PTR override source-run response should identify current runtime phase");
...
static int test_phase26_header_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 26 header response should identify current runtime phase");
...
static int test_phase28_additional_data_sections_source_run_programs(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":75", "Phase 30 response should identify current runtime phase");
...
static int test_phase30_dup_initializer_list_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "DUP initializer list source should report current runtime/source-run MASM behavior phase metadata");
...
static int test_phase41_irvine32_virtual_include_metadata_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Irvine32 virtual include response should report current runtime/source-run MASM behavior phase metadata");
...
static int test_phase42_irvine32_exit_terminator_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Irvine32 exit response should report current runtime/source-run MASM behavior phase metadata");
...
static int test_phase43_inc_dec_register_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 43 INC/DEC response should report current runtime metadata");
...
static int test_phase44_logical_binary_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 44 logical response should report current runtime metadata");
...
static int test_phase45_not_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Milestone 45 NOT regression response should report current runtime/source-run MASM behavior phase metadata");
...
static int test_phase46_shift_left_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 46 SHL/SAL response should report current runtime metadata");
...
static int test_phase47_shr_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 47 SHR regression should report current runtime/source-run MASM behavior phase metadata");
...
static int test_phase48_sar_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 48 SAR response should report current runtime metadata");
...
static int test_phase49_rol_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 49 ROL response should report current runtime metadata");
...
static int test_phase50_ror_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 50 ROR response should report current runtime metadata");
...
static int test_phase52_lea_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 52 LEA response should report current runtime metadata");
...
static int test_phase57corr2_compact_negative_displacement_write_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 57-CORR2 write response should report current numeric runtime metadata");
...
static int test_phase57corr2_compact_negative_displacement_read_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 57-CORR2 read response should report current numeric runtime metadata");
...
static int test_phase57corr2_compact_negative_displacement_lea_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 57-CORR2 LEA response should report current numeric runtime metadata");
...
static int test_phase53_mul_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 53 MUL response should report current runtime metadata");
...
static int test_phase56_div_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 56 DIV response should report current runtime metadata");
...
static int test_phase57_idiv_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 57 IDIV response should report runtime metadata");
...
static int test_phase54_imul_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 54 IMUL response should report current runtime metadata");
...
static int test_phase55_imul_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 55 IMUL response should report current runtime metadata");
...
static int test_phase57e_default_startup_state_notice_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Startup-state notice regression should report current numeric phase metadata");
...
static int test_phase58_label_source_run_behavior(void) {
    ...
    failures += expect_json_contains(labeled_copy, "\"phase\":75", "Labeled source should report numeric current runtime phase metadata");
    failures += expect_json_contains(labeled_copy, "\"phaseName\":\"Phase 75 - PROC Metadata Baseline and Attribute Diagnostics\"", "Labeled source should report current runtime phase name");
...
static int test_phase64_equality_jumps_source_run_programs(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":75", "Equality-jump regression should report current numeric phase metadata");
    failures += expect_json_contains(acceptance_json, "\"phaseName\":\"Phase 75 - PROC Metadata Baseline and Attribute Diagnostics\"", "Equality-jump regression should report current runtime phase name");
...
static int test_phase65_signed_relational_jumps_source_run_programs(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":75", "current runtime acceptance program should report numeric metadata");
    failures += expect_json_contains(acceptance_json, "\"phaseName\":\"Phase 75 - PROC Metadata Baseline and Attribute Diagnostics\"", "current runtime acceptance program should report runtime phase name");
...
static int test_phase69_direct_call_source_run_behavior(void) {
    ...
    failures += expect_json_contains(valid_copy, "\"phase\":75", "Phase 69 CALL regression fixture should report current Phase 72 runtime metadata");
...
static int test_phase71_call_ret_source_run_behavior(void) {
    ...
    failures += expect_json_contains(success_copy, "\"phase\":75", "Phase 71 CALL/RET acceptance program should report numeric phase metadata");
    failures += expect_json_contains(success_copy, "\"phaseName\":\"Phase 75 - PROC Metadata Baseline and Attribute Diagnostics\"", "Phase 71 CALL/RET acceptance program should report runtime phase name");
...
/// Verifies current Phase 75 runtime/source-run status metadata is emitted by source-run JSON.
///
/// @return Number of failures.
static int test_current_source_run_phase_metadata(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Runtime metadata should report numeric Phase 75 metadata");
    failures += expect_json_contains(json, "\"phaseSuffix\":\"\"", "Phase 75 should report the suffix field");
    failures += expect_json_contains(json, "\"phaseName\":\"Phase 75 - PROC Metadata Baseline and Attribute Diagnostics\"", "Phase 75 should report the runtime phase name");
    failures += expect_json_contains(json, TEST_SOURCE_RUN_OUTPUT_CONTRACT_FRAGMENT, "Phase 75 should report separate source-run output-contract metadata");
...
static int test_phase67a_entry_procedure_runtime_boundary_source_run(void) {
    ...
    failures += expect_json_contains(before_copy, "\"phase\":75", "Phase 67A helper-before-entry source should report numeric phase metadata");
...
static int test_phase50b_undefined_flag_use_warn_policy_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 50B source-run response should report current numeric runtime metadata");
...
static int test_phase57corr1_const_cross_region_write_diagnostic_context(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 57-CORR1 regression should report current runtime/source-run phase metadata");
...
static int test_phase61_jmp_executes_after_prior_instruction(void) {
    ...
    failures += expect_json_contains(json_copy, "\"phase\":75", "JMP regression response should report current Phase 71 numeric phase metadata");
...
static int test_phase61a_jmp_skips_memory_write_and_keeps_console_empty(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "current runtime should report numeric phase metadata");
    failures += expect_json_contains(json, "\"phaseName\":\"Phase 75 - PROC Metadata Baseline and Attribute Diagnostics\"", "Phase 75 should report the runtime phase name");
...
static int test_phase73_leave_source_run_semantics_and_diagnostics(void) {
    ...
    failures += expect_json_contains(direct_json, "\"phase\":75", "Phase 75 source-run should report numeric phase");
    failures += expect_json_contains(direct_json, "\"phaseSuffix\":\"\"", "Phase 75 source-run should report empty suffix metadata");
    failures += expect_json_contains(direct_json, TEST_SOURCE_RUN_OUTPUT_CONTRACT_FRAGMENT, "Phase 75 source-run should report current output contract");
...
/// Verifies current source-run metadata exposes Phase 75 and the default callDepthLimit.
///
/// @return Zero on success, otherwise a positive failure count.
static int test_phase73_source_run_default_metadata_and_call_depth(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":75", "Phase 75 default source-run metadata should report numeric phase");
    failures += expect_json_contains(json, "\"phaseSuffix\":\"\"", "Phase 75 default source-run metadata should report suffix metadata");
    failures += expect_json_contains(json, "\"phaseName\":\"Phase 75 - PROC Metadata Baseline and Attribute Diagnostics\"", "Phase 75 default source-run metadata should report full phase name");
    failures += expect_json_contains(json, TEST_SOURCE_RUN_OUTPUT_CONTRACT_FRAGMENT, "Phase 75 default source-run metadata should report current output contract");
...
static int test_phase74_ret_imm16_source_run_semantics_and_diagnostics(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":75", "Phase 74 RET imm16 regression should report current numeric phase");
...
/// Verifies Phase 75 PROC diagnostics are emitted through source-run JSON.
///
/// @return Zero on success, otherwise a positive failure count.
static int test_phase75_proc_diagnostics_source_run(void) {
    int failures = 0;
    char unsupported_json[TEST_JSON_COPY_CAPACITY];
    char mismatch_json[TEST_JSON_COPY_CAPACITY];
    char duplicate_json[TEST_JSON_COPY_CAPACITY];

    copy_source_run_json(unsupported_json, sizeof(unsupported_json), masm32_sim_wasm_run_source_json(
        ".code\n"
        "MyProc PROC USES eax ebx\n"
        "MyProc ENDP\n"
        "END MyProc\n"
    ));
    failures += expect_json_contains(unsupported_json, "\"ok\":false", "unsupported PROC attribute should fail source-run before execution");
    failures += expect_json_contains(unsupported_json, "\"status\":\"parse-error\"", "unsupported PROC attribute should be a parse error");
    failures += expect_json_contains(unsupported_json, "\"kind\":\"assembly-error\"", "unsupported PROC attribute should render as assembly error");
    failures += expect_json_contains(unsupported_json, "\"code\":\"unsupported-proc-attribute\"", "unsupported PROC attribute should use Phase 75 diagnostic code");
    failures += expect_json_contains(unsupported_json, "PROC attribute or parameter", "unsupported PROC attribute diagnostic should explain PROC tail rejection");
    failures += expect_json_contains(unsupported_json, "`USES`", "unsupported PROC attribute diagnostic should name the rejected attribute");
    failures += expect_json_contains(unsupported_json, "\"line\":2", "unsupported PROC attribute diagnostic should preserve line");
    failures += expect_json_contains(unsupported_json, "\"column\":13", "unsupported PROC attribute diagnostic should preserve column");
    failures += expect_json_contains(unsupported_json, "\"byteOffset\":18", "unsupported PROC attribute diagnostic should preserve byte offset");
    failures += expect_json_contains(unsupported_json, "\"spanLength\":4", "unsupported PROC attribute diagnostic should preserve span length");
    failures += expect_json_not_contains(unsupported_json, "expected-line-end", "unsupported PROC attribute should not fall back to generic line-end diagnostics");
    failures += expect_json_not_contains(unsupported_json, "execution-complete", "unsupported PROC attribute should not execute");
    ...
    failures += expect_json_contains(mismatch_json, "\"column\":1", "mismatched ENDP diagnostic should preserve column");
...
static const SourceRunTestCase SOURCE_RUN_TEST_CASES[] = {
    ...
    {"test_phase75_proc_diagnostics_source_run", SOURCE_RUN_TEST_DIAGNOSTICS, test_phase75_proc_diagnostics_source_run},
...
int main(int argc, char **argv) {
    ...
    if (has_filter) {
        ...
        puts("Source execution tests through Phase 75 PROC diagnostics behavior passed.");
    }
    return 0;
}
