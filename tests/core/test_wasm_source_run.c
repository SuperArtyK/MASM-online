 ...
 * @brief Tests for the Wasm-facing source execution API through Phase 41 regression coverage.
 *
...
static int test_minimal_source_runs_to_eax_42(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "response should identify Milestone 41");
...
static int test_phase24_eax_base_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "Phase 26 EAX-base response should identify Milestone 41");
...
static int test_all_gpr_register_indirect_source_run_succeeds(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "all-GPR response should identify Milestone 41");
...
static int test_phase22_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "Phase 22 response should identify Milestone 41");
...
static int test_signed_ptr_alias_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "signed PTR alias response should identify Milestone 41");
...
static int test_phase20_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "source-run response should identify Milestone 41");
...
static int test_phase25_register_supplied_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "Phase 26 source-run response should identify Milestone 41");
...
static int test_phase25_register_supplied_source_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "Phase 26 source-memory response should identify Milestone 41");
...
static int test_phase25_explicit_ptr_symbol_register_override_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "Explicit PTR override source-run response should identify Milestone 41");
...
static int test_phase26_header_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "Phase 26 header response should identify Milestone 41");
...
static int test_phase28_additional_data_sections_source_run_programs(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":41", "Phase 30 response should identify Milestone 41");
...
static int test_phase30_dup_initializer_list_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "DUP initializer list source should report phase 30");
...
static int test_phase41_irvine32_virtual_include_metadata_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "Phase 41 response should report milestone metadata");
...
static int test_phase41_irvine32_unsupported_routine_source_run_diagnostic(void) {
    ...
    failures += expect_json_contains(json, "\"ok\":false", "exit should not execute before Phase 42");
    failures += expect_json_contains(json, "\"code\":\"unsupported-irvine32-routine\"", "exit should use the Phase 41 Irvine32 diagnostic before Phase 42");
    failures += expect_json_not_contains(json, "execution-complete", "exit diagnostic must prevent execution before Phase 42");
...
int main(void) {
    ...
    puts("Source execution tests through Phase 41 regression coverage passed.");
    return 0;
}
