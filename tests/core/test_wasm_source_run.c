 ...
 * @brief Tests for the Wasm-facing source execution API through Phase 60 direct JMP parsing and target lowering.
 *
...
static int test_minimal_source_runs_to_eax_42(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "response should identify Phase 60");
...
static int test_phase24_eax_base_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 26 EAX-base response should identify Phase 60");
...
static int test_all_gpr_register_indirect_source_run_succeeds(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "all-GPR response should identify Phase 60");
...
static int test_phase22_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 22 response should identify Phase 60");
...
static int test_signed_ptr_alias_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "signed PTR alias response should identify Phase 60");
...
static int test_phase20_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "source-run response should identify Phase 60");
...
static int test_phase25_register_supplied_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 26 source-run response should identify Phase 60");
...
static int test_phase25_register_supplied_source_memory_width_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 26 source-memory response should identify Phase 60");
...
static int test_phase25_explicit_ptr_symbol_register_override_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Explicit PTR override source-run response should identify Phase 60");
...
static int test_phase26_header_source_run_acceptance_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 26 header response should identify Phase 60");
...
static int test_phase28_additional_data_sections_source_run_programs(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":60", "Phase 30 response should identify Phase 60");
...
static int test_phase30_dup_initializer_list_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "DUP initializer list source should report runtime/source-run MASM behavior phase metadata");
...
static int test_phase41_irvine32_virtual_include_metadata_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Irvine32 virtual include response should report runtime/source-run MASM behavior phase metadata");
...
static int test_phase42_irvine32_exit_terminator_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Irvine32 exit response should report runtime/source-run MASM behavior phase metadata");
...
static int test_phase43_inc_dec_register_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 43 INC/DEC response should report milestone metadata");
...
static int test_phase44_logical_binary_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 44 logical response should report milestone metadata");
...
static int test_phase45_not_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Milestone 45 NOT regression response should report runtime/source-run MASM behavior phase metadata");
...
static int test_phase46_shift_left_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 46 SHL/SAL response should report milestone metadata");
...
static int test_phase47_shr_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 47 SHR regression should report runtime/source-run MASM behavior phase metadata");
...
static int test_phase48_sar_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 48 SAR response should report milestone metadata");
...
static int test_phase49_rol_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 49 ROL response should report milestone metadata");
...
static int test_phase50_ror_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 50 ROR response should report milestone metadata");
...
static int test_phase52_lea_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 52 LEA response should report milestone metadata");
...
static int test_phase57corr2_compact_negative_displacement_write_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 57-CORR2 write response should report runtime Phase 60 metadata");
...
static int test_phase57corr2_compact_negative_displacement_read_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 57-CORR2 read response should report runtime Phase 60 metadata");
...
static int test_phase57corr2_compact_negative_displacement_lea_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 57-CORR2 LEA response should report runtime Phase 60 metadata");
...
static int test_phase53_mul_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 53 MUL response should report milestone metadata");
...
static int test_phase56_div_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 56 DIV response should report milestone metadata");
...
static int test_phase57_idiv_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 57 IDIV response should report runtime metadata");
...
static int test_phase54_imul_source_run_program(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 54 IMUL response should report milestone metadata");
...
static int test_phase55_imul_source_run_programs(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 55 IMUL response should report milestone metadata");
...
static int test_phase57e_default_startup_state_notice_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Startup-state notice regression should report current numeric phase metadata");
...
static int test_phase58_label_source_run_behavior(void) {
    ...
    failures += expect_json_contains(labeled_copy, "\"phase\":60", "Labeled source should report numeric Phase 60 metadata");
    failures += expect_json_contains(labeled_copy, "\"phaseName\":\"Phase 60 - Direct JMP Parsing and Target Lowering\"", "Labeled source should report Phase 60 runtime phase name");
    ...
    failures += expect_json_contains(jmp_copy, "\"ok\":false", "jmp label source should stop before deferred branch execution");
    failures += expect_json_contains(jmp_copy, "branch-runtime-deferred", "jmp label source should use Phase 60 deferred branch diagnostic");
    ...
    failures += expect_json_not_contains(jmp_copy, "execution-complete", "jmp label source should not execute branch behavior");
...
/// Verifies Phase 60 runtime/source-run status metadata is emitted by source-run JSON.
///
/// @return Number of failures.
static int test_phase59_source_run_phase_metadata(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Runtime metadata should preserve numeric phase 60 metadata");
    failures += expect_json_contains(json, "\"phaseSuffix\":\"\"", "Phase 60 should report the suffix field");
    failures += expect_json_contains(json, "\"phaseName\":\"Phase 60 - Direct JMP Parsing and Target Lowering\"", "Phase 60 should report the runtime phase name");
...
static int test_phase50b_undefined_flag_use_warn_policy_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 50B source-run response should report current numeric milestone metadata");
...
static int test_phase57corr1_const_cross_region_write_diagnostic_context(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":60", "Phase 57-CORR1 must not advance runtime/source-run phase metadata");
...
/// Verifies Phase 60 stops at a lowered direct JMP without executing it.
///
/// @return Number of failures.
static int test_phase60_jmp_runtime_deferred_after_prior_instruction(void) {
    ...
    failures += expect_json_contains(json_copy, "\"phase\":60", "Phase 60 JMP response should report numeric phase metadata");
    failures += expect_json_contains(json_copy, "\"ok\":false", "reaching Phase 60 JMP should fail before execution");
    failures += expect_json_contains(json_copy, "\"status\":\"execution-error\"", "deferred JMP should report execution error status");
    failures += expect_json_contains(json_copy, "\"instructionCount\":1", "only instruction before JMP should be committed");
    failures += expect_json_contains(json_copy, "\"executedInstructionCount\":1", "deferred JMP should preserve committed instruction count");
    failures += expect_json_contains(json_copy, "\"attemptedNextInstructionIndex\":1", "deferred JMP should be the attempted next instruction");
    failures += expect_json_contains(json_copy, "\"currentInstructionIndex\":0", "last committed instruction should be the MOV before JMP");
    ...
    failures += expect_json_contains(json_copy, "\"ECX\":{\"hex\":\"00000000h\",\"unsigned\":0}", "target instruction should not run before Phase 61");
    failures += expect_json_contains(json_copy, "\"code\":\"branch-runtime-deferred\"", "deferred JMP should emit branch-runtime-deferred");
    failures += expect_json_not_contains(json_copy, "\"code\":\"execution-complete\"", "deferred JMP should not emit execution-complete");

    return failures;
}

/// Verifies Phase 60 stops at a first-instruction JMP with no committed mutation.
///
/// @return Number of failures.
static int test_phase60_jmp_runtime_deferred_first_instruction(void) {
    const char *json = masm32_sim_wasm_run_source_json(
        ".code\n"
        "main PROC\n"
        "    jmp done\n"
    ...
    failures += expect_json_contains(json, "\"ok\":false", "first-instruction JMP should stop before branch execution");
    failures += expect_json_contains(json, "\"instructionCount\":0", "first-instruction JMP should commit zero instructions");
    failures += expect_json_contains(json, "\"executedInstructionCount\":0", "first-instruction JMP should report zero executed instructions");
    failures += expect_json_contains(json, "\"attemptedNextInstructionIndex\":0", "first-instruction JMP should be attempted index 0");
    failures += expect_json_contains(json, "\"currentInstructionIndex\":null", "first-instruction JMP should have no current committed instruction");
    failures += expect_json_contains(json, "\"memoryChanges\":[]", "first-instruction JMP should not produce memory changes");
    failures += expect_json_contains(json, "\"EAX\":{\"hex\":\"00000000h\",\"unsigned\":0}", "first-instruction JMP should not mutate EAX");

    return failures;
}

/// Verifies Phase 59 instruction-limit precedence remains before a later Phase 60 JMP.
///
/// @return Number of failures.
static int test_phase60_jmp_respects_instruction_limit_precedence(void) {
...
int main(void) {
    ...
    failures += test_phase59_source_run_phase_metadata();
    failures += test_phase59_instruction_limit_source_run();
    failures += test_phase60_jmp_runtime_deferred_after_prior_instruction();
    failures += test_phase60_jmp_runtime_deferred_first_instruction();
    failures += test_phase60_jmp_respects_instruction_limit_precedence();
    ...
    puts("Source execution tests through Phase 60 direct JMP parsing and target lowering passed.");
    return 0;
}
