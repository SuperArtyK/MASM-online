...
static int test_all_gpr_register_indirect_bases_source_run(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "all-GPR response should identify Milestone 30");
...
static int test_symbol_register_memory_forms_execute(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "response should identify Milestone 30");
...
static int test_signed_ptr_width_aliases_source_run_programs(void) {
    ...
    failures += expect_json_contains(read_copy, "\"phase\":41", "signed PTR read response should identify Milestone 30");
...
static int test_additional_data_sections_layout_and_const_protection(void) {
    ...
    failures += expect_json_contains(acceptance_json, "\"phase\":41", "additional data source-run should identify Milestone 30");
...
static int test_phase29_extended_constant_expressions(void) {
    ...
    failures += expect_json_contains(json, "\"phase\":41", "Milestone 30 response should identify phase 30");
