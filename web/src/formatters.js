/*
 * @file formatters.js
 * @brief Pure UI formatting helpers for Milestone 12 browser output.
 *
...
/** Canonical MASM32 register display order for the Milestone 12 final-state panel. */
const CANONICAL_REGISTER_DISPLAY_ORDER = ["EAX", "EBX", "ECX", "EDX", "ESI", "EDI", "EBP", "ESP", "EIP", "EFLAGS"];

/**
 * Formats one register value for the Milestone 12 final-register panel.
 *
