 ...
 *
 * The worker owns Wasm loading and Milestone 30 source execution so parsing and
...
/**
 * Creates a JavaScript source-runner around the Milestone 30 C export.
 *
...
async function loadWasmRuntime() {
  ...
  if (typeof moduleInstance.ccall !== "function" || typeof moduleInstance._masm32_sim_wasm_run_source_json !== "function") {
    return {
      ...
      testValue,
      sourceExecution: "unavailable",
      message: "Wasm artifact loaded, but the Milestone 30 source execution export was not found. Rebuild the Wasm artifact."
    };
  }
