...
export const IMPLEMENTED_PHASE = 80;
...
export const IMPLEMENTED_PHASE_NAME = "Phase 80 - LOCAL Operand Resolution and Addressing";

/** Source-run JSON output-contract identifier expected by the current browser/protocol layer. */
export const SOURCE_RUN_OUTPUT_CONTRACT = "phase-80-local-operand-output-contract-v1";
