...
export const IMPLEMENTED_PHASE = 81;
...
export const IMPLEMENTED_PHASE_NAME = "Phase 81 - PROTO Metadata Parser";

/** Source-run JSON output-contract identifier expected by the current browser/protocol layer. */
export const SOURCE_RUN_OUTPUT_CONTRACT = "phase-81-proto-metadata-output-contract-v1";
