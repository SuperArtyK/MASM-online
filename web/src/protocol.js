...
export const IMPLEMENTED_PHASE = 93;
...
export const IMPLEMENTED_PHASE_NAME = "Phase 93 - Irvine32 WriteBin";

/** Source-run JSON output-contract identifier expected by the current browser/protocol layer. */
export const SOURCE_RUN_OUTPUT_CONTRACT = "phase-93-irvine32-writebin-contract-v1";
