 ...
 *
 * The protocol supports readiness, ping/pong diagnostics, and the Milestone 14
...
export const IMPLEMENTED_PHASE = 14;
...
function createRunSourceUnavailableError() {
  return {
    ...
    payload: {
      ...
      message: "The Wasm source execution export is unavailable. Rebuild the Wasm artifact after Milestone 14."
    }
  };
}
