 ...
 *
 * The protocol supports readiness, ping/pong diagnostics, and the Milestone 16
...
export const IMPLEMENTED_PHASE = 16;
...
function createRunSourceUnavailableError() {
  return {
    ...
    payload: {
      ...
      message: "The Wasm source execution export is unavailable. Rebuild the Wasm artifact after Milestone 16."
    }
  };
}
