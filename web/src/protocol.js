...
export const IMPLEMENTED_PHASE = 92;
...
export const IMPLEMENTED_PHASE_NAME = "Phase 92 - Irvine32 WriteHex";

/** Source-run JSON output-contract identifier expected by the current browser/protocol layer. */
export const SOURCE_RUN_OUTPUT_CONTRACT = "phase-92-irvine32-writehex-contract-v1";
