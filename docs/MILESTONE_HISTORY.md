...
Forward-looking phase navigation is guide-owned. At the time this history entry was updated, Phase 80 had been implemented as LOCAL operand resolution and addressing on top of Phase 79 automatic LOCAL stack allocation and lifetime. That statement is historical navigation for this history entry, not an implementation permission by itself and not a substitute for reading the current implementation guide.
