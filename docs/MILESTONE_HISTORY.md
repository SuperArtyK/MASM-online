...
Forward-looking phase navigation is guide-owned. At the time this history entry was updated, Phase 71D had been implemented as configurable procedure-fallthrough diagnostic policy, then the guide kept Phase 71E through Phase 71F before Phase 72. That statement is historical navigation for this history entry, not an implementation permission by itself and not a substitute for reading the current implementation guide.
