...
For Phase 89 - Irvine32 WriteString, this smoke-test rule is triggered if the implementation changes any of the following:
...
| `CALL WriteDec` or another still-deferred Irvine32 routine | `unsupported-feature` | `unsupported-irvine32-routine` | Proves that implemented Irvine32 output routines did not execute future Irvine32 routines. |
