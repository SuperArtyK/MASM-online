...
Phase 59 - Control-Flow Instruction Limit: Code labels and procedure-entry labels are accepted as parser/source metadata. Duplicate or conflicting labels produce structured Simulator Messages diagnostics. Labels do not execute, do not create IR instructions, and do not add branch behavior.
