...
emcc \
  ...
  -sEXPORTED_FUNCTIONS='["_masm32_sim_wasm_test_value","_masm32_sim_wasm_milestone4_hardcoded_result","_masm32_sim_wasm_run_source_json","_masm32_sim_wasm_copy_version"]' \
