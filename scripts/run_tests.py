...
def run_structure_tests() -> None:
    ...
    assert_text_contains("README.md", "Phase 87 - Irvine32 Crlf")
    assert_text_contains("README.md", "Phase 87 is the current runtime/source-run behavior milestone")
    ...
    assert_text_contains("web/src/protocol.js", "IMPLEMENTED_PHASE = 87")
    assert_text_contains("web/src/protocol.js", "IMPLEMENTED_PHASE_SUFFIX = \"\"")
    assert_text_contains("web/src/protocol.js", "Phase 87 - Irvine32 Crlf")
    ...
    assert_text_contains("tests/core/test_wasm_source_run.c", "Source execution tests through Phase 87 Irvine32 Crlf passed.")
...
def assert_current_status_and_harness_documented() -> None:
    ...
    assert_all_text_contains(
        ...
        [
            ...
            "Phase 87 is the current runtime/source-run behavior milestone",
            "stack-overflow",
            "stack-underflow",
    ...
    assert_all_text_contains(
        ...
        [
            "Current milestone:",
            "Phase 87 - Irvine32 Crlf",
            "Phase 87 advances runtime/source-run behavior metadata",
    ...
    assert_all_text_contains(
        ...
        [
            ...
            "phase-87-irvine32-crlf-contract-v1",
