...
def run_structure_tests() -> None:
    ...
    assert_text_contains("README.md", "through Milestone 18")
    assert_text_contains("docs/SUPPORTED_SYNTAX.md", "through Milestone 18")
    ...
    assert_text_contains("web/src/protocol.js", "IMPLEMENTED_PHASE = 18")
