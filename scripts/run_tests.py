...
def run_structure_tests() -> None:
    ...
    assert_text_contains("src/core/vm_ir.h", "/// Identifies the minimal Milestone 4 IR operation code")
    assert_text_contains("src/core/vm_ir.h", "VmIrInstruction vm_ir_instruction")
    assert_text_contains("src/core/vm_exec.h", "/// Owns Milestone 4 CPU")
    ...
    assert_text_contains("tests/core/test_data_section.c", "/// Verifies Milestone 10 data layout")
