...
def run_structure_tests() -> None:
    ...
    assert_text_contains("docs/SUPPORTED_SYNTAX.md", "through Milestone 52")
    ...
    assert_text_contains("web/src/protocol.js", "IMPLEMENTED_PHASE = 52")
    ...
    assert_text_contains("tests/core/test_wasm_source_run.c", "Source execution tests through Phase 52 LEA coverage passed.")
