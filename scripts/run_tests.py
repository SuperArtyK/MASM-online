...
def run_structure_tests() -> None:
    ...
    assert_text_contains("README.md", "Phase 57R - Unsupported INVOKE, ADDR, and External Routine Diagnostics")
    ...
    assert_text_contains("tests/core/test_wasm_source_run.c", "Source execution tests through Phase 57R INVOKE/ADDR diagnostic coverage passed.")
...
def assert_phase57r_status_and_code_policy_present() -> None:
    """Verify Phase 57R repository/runtime status and Phase 57L policy retention."""
...
def run_static_tests() -> None:
    ...
    assert_phase57r_status_and_code_policy_present()
