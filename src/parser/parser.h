...
typedef struct VmParserResult {
    ...
    /// Requested stack size in bytes from `.stack size`; Phase 72A source-level PUSH/POP and Phase 79 automatic LOCAL frame capacity checks use this metadata, while `.stack` alone does not create a frame.
