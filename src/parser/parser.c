 ...
 * Phase 87 virtual Irvine32 Crlf CALL/INVOKE lowering, Phase 88 direct WriteChar lowering, Phase 89 direct WriteString lowering, and Phase 90 direct WriteDec lowering are supported; the Phase 79 executor uses parser-owned LOCAL metadata to create
 ...
 * Irvine32 routine bodies beyond Crlf, direct WriteChar, direct WriteString, and direct WriteDec, and full MASM expression parsing remain later
